        ...
        <div className="container relative">
          <AnimatedSection>
            <div className="text-center mb-16">
              <span className="section-label text-white/30 mb-4 inline-block">Target Industries</span>
                      ...
                      <div className="space-y-3">
                        {industry.workflows.map((workflow) => (
                          ...
                          >
                            ...
                            <span className="text-sm text-white/60">{workflow}</span>
                          </div>
                        ))}
                      </div>
                    </div>
          ...
          <div className="grid sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <AnimatedSection delay={0.1}>
              <div className="rounded-2xl glass-card p-6 text-center">
                ...
                <p className="text-sm text-white/40">Pre-built and configurable. No long custom build-outs — launch in days, not months.</p>
              </div>
            </AnimatedSection>
            <AnimatedSection delay={0.15}>
              <div className="rounded-2xl glass-card p-6 text-center">
                ...
                <p className="text-sm text-white/40">Designed for your industry's sales cycle, compliance needs, and common objections.</p>
              </div>
            </AnimatedSection>
            <AnimatedSection delay={0.2}>
              <div className="rounded-2xl glass-card p-6 text-center">
                ...
                <p className="text-sm text-white/40">Start as a solo agent and grow. Add more workflows or team seats as you scale.</p>
              </div>
            </AnimatedSection>
          </div>
        </div>
